...
Rarefactor is a two-part demo application that showcases a Python backend with gRPC + FastAPI and a modern React (Vite + TypeScript + Mantine) client. This root README explains the repository layout and the sub-applications inside.
...
- client
  - React + TypeScript + Vite single-page app for search UI and results, styled with Mantine.
